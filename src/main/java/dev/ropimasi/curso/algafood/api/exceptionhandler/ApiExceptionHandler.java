...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Houve um erro inespecífico no sistema. Tente novamente e se o "
			+ "problema persistir, entre em contato com o administrador do sistema.";



	@ExceptionHandler(Exception.class)
	public ResponseEntity<?> handleDemaisException(Exception ex, WebRequest request) {
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("O recurso '%s', que você " + "tentou encontrar, não existe.",
				ex.getRequestURL());
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		// adicionar apache.commons-lang3 no pom.xml.
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers,
		...
		String detail = String.format("A propriedade '%s' não existe ou está indisponível para esta entidade. "
